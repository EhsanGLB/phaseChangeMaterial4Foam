...
m4_define(widthB, 70)
m4_define(length, 10)
m4_define(numberOfCell_x, 70)
m4_define(numberOfCell_y, 120)
...
blocks
(
    hex (B0 B1 B2 B3 F0 F1 F2 F3) chamber (numberOfCell_x numberOfCell_y numberOfCell_z) simpleGrading (1 1 1)
);
