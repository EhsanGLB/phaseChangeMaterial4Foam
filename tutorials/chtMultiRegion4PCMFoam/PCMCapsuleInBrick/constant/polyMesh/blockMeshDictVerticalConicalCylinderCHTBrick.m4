...
m4_define(extCyRB, 28.0)
m4_define(extCyRT, 28.0)
m4_define(extCyH, 65)

m4_define(extCyRN, 15)
...
(
  ...
  //-External square
    hex (extCyB0 extCyB3 extCyT3 extCyT0 extSqB0 extSqB3 extSqT3 extSqT0) brick (extSqWN extSqHN extSqWN) simpleGrading (1 1 1)
    hex (extCyB3 extCyB2 extCyT2 extCyT3 extSqB3 extSqB2 extSqT2 extSqT3) brick (extSqWN extSqHN extSqWN) simpleGrading (1 1 1)
    hex (extCyB2 extCyB1 extCyT1 extCyT2 extSqB2 extSqB1 extSqT1 extSqT2) brick (extSqWN extSqHN extSqWN) simpleGrading (1 1 1)
    hex (extCyB1 extCyB0 extCyT0 extCyT1 extSqB1 extSqB0 extSqT0 extSqT1) brick (extSqWN extSqHN extSqWN) simpleGrading (1 1 1)
);
