...
Foam::robin4PCMFoam::robin4PCMFoam
(
    const fvPatch& p,
...
Foam::scalar Foam::robin4PCMFoam::qoFunction(scalar t)
{
    int n_ = 0;
    scalar f_ = 0.0;
...
Foam::scalar Foam::robin4PCMFoam::hoFunction(scalar t)
{
    int n_ = 0;
    scalar f_ = 0.0;
...
Foam::scalar Foam::robin4PCMFoam::ToFunction(scalar t)
{
    int n_ = 0;
    scalar f_ = 0.0;
...
void Foam::robin4PCMFoam::updateCoeffs()
{
    if (updated())
    {
        return;
...
void Foam::robin4PCMFoam::write(Ostream& os) const
{
